...
function Shows() {
 ...
 className="hero-video"
  src="https://www.youtube.com/embed/1qH_9vVZtXo?autoplay=1&mute=1&controls=0&loop=1&playlist=1qH_9vVZtXo"
        ...
        <div className="rows">
          ...
          <div className="row-wrapper">
            ...
            <div className="row-posters" id="row1">
              {shows
                .filter((movie) => movie.category === "odd")
                .map((movie) => (
                  <img
                    key={movie._id}
                    src={movie.file}
          ...
          <h2 className="row-title">Horror</h2>
          <div className="row-wrapper">
            <button
              className="scroll-btn left"
          ...
          <h2 className="row-title">Indian social issue</h2>
          <div className="row-wrapper">
            <button
              className="scroll-btn left"
          ...
          <div className="row-wrapper">
            ...
            <div className="row-posters" id="row4">
              {shows
                .filter((movie) => movie.category === "thrill")
                .map((movie) => (
                  <img
                    key={movie._id}
                    src={movie.file}
